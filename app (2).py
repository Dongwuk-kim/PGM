...
from BPM_MF_algo import error_calculation
import BPM_MF_algo
...
# data_df = pd.read_csv('ml-25m/ratings.csv')
...
# calculate a training error
predicted_matrix = output.q_m
train_matrix = sparse_user_item_m.toarray()
# MAE
error_calculation(train_matrix, predicted_matrix, "MAE")
# CMAE
error_calculation(train_matrix, predicted_matrix, "CMAE")
# 0-1 Loss
error_calculation(train_matrix, predicted_matrix, "0-1-Loss")